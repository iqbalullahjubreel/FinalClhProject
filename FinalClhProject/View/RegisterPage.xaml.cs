...
public partial class RegisterPage : ContentPage
{
    ...
    public RegisterPage(RegisterViewModel viewModel, IGoogleSignInService googleSignInService, FinalClhProjDbContext dbContext, IGoogleSignInRepository googleSignInRepository)
    {
        InitializeComponent();
